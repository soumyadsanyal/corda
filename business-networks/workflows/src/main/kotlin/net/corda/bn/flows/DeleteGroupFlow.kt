 ...
 */
@InitiatingFlow
class DeleteGroupFlow(private val groupId: UniqueIdentifier, private val notary: Party? = null) : MembershipManagementFlowImpl<SignedTransaction>() {
...
class DeleteGroupResponderFlow(private val session: FlowSession) : MembershipManagementFlowImpl<Unit>() {
