 ...
 */
@InitiatingFlow
class ModifyRolesFlow(private val membershipId: UniqueIdentifier, private val roles: Set<BNRole>, private val notary: Party? = null) : MembershipManagementFlowImpl<SignedTransaction>() {
...
class ModifyRolesResponderFlow(private val session: FlowSession) : MembershipManagementFlowImpl<Unit>() {
