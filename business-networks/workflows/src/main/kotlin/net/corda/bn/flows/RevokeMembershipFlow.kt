 ...
 */
@InitiatingFlow
class RevokeMembershipFlow(private val membershipId: UniqueIdentifier, private val notary: Party? = null) : MembershipManagementFlowImpl<SignedTransaction>() {
...
class RevokeMembershipFlowResponder(val session: FlowSession) : MembershipManagementFlowImpl<Unit>() {
