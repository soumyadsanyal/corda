 ...
 */
@InitiatingFlow
class ActivateMembershipFlow(private val membershipId: UniqueIdentifier, private val notary: Party? = null) : MembershipManagementFlowImpl<SignedTransaction>() {
...
class ActivateMembershipResponderFlow(private val session: FlowSession) : MembershipManagementFlowImpl<Unit>() {
