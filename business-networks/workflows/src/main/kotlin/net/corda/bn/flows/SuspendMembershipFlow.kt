 ...
 */
@InitiatingFlow
class SuspendMembershipFlow(private val membershipId: UniqueIdentifier, private val notary: Party? = null) : MembershipManagementFlowImpl<SignedTransaction>() {
...
class SuspendMembershipFlowResponder(private val session: FlowSession) : MembershipManagementFlowImpl<Unit>() {
