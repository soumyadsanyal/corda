...
class CreateGroupFlow(
    ...
    @Suspendable
    override fun getConcreteImplementationFlow(service: BusinessNetworksService): MembershipManagementFlow<Unit> = service.createGroupFlow(networkId, groupId, groupName, additionalParticipants, notary)
}